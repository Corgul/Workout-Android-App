...
class SaveExercises @Inject constructor(
    ...
    suspend operator fun invoke(workoutId: Long, numberOfExercisesForWorkout: Int, exerciseNameList: List<ExerciseName>) {
        // Save the list of exercises
        val exerciseList = Exercise.from(workoutId, numberOfExercisesForWorkout, exerciseNameList)
